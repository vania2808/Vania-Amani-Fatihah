...
Original file is located at
    https://colab.research.google.com/drive/11vo2siyU2jS7Q4DgCZ9V4R2jzNTAYF_T
...
# Gantilah 'Profitability' dengan nama kolom target yang sesuai setelah Anda memeriksa nama kolom
X = data.drop('Profitability', axis=1)  # Ganti 'Profitability' dengan nama kolom target Anda
y = data['Profitability']  # Ganti 'Profitability' dengan nama kolom target Anda

# Mengubah nilai kategori dalam kolom target menjadi nilai numerik
